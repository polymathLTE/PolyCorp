              ...
              <Card className="bg-card border-border/50">
                <CardContent className="pt-6">
                  <div className="text-center mb-6">
                    <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-primary via-secondary to-primary flex items-center justify-center text-4xl font-bold text-background">
                      PC
                    </div>
                    <h3 className="font-heading font-semibold text-xl text-foreground">Polymath Corporation</h3>
                    <p className="text-sm text-muted-foreground">Innovative AI Solutions Provider</p>
                  </div>

                  <div className="space-y-4">
                    <div className="flex items-center gap-3 text-sm">
                      <MapPin className="h-4 w-4 text-secondary" />
                      <span className="text-foreground">Lekki, Lagos, Nigeria</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <Mail className="h-4 w-4 text-secondary" />
                      <Link href="mailto:hello@polymathcorp.works" className="text-muted-foreground hover:text-secondary transition-colors">
                        hello@polymathcorp.works
                      </Link>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <Phone className="h-4 w-4 text-secondary" />
                      <Link href="tel:+2347065533470" className="text-muted-foreground hover:text-secondary transition-colors">
                        +234 706 553 3470
                      </Link>
                    </div>
                  </div>
                  ...
                  <Button asChild className="w-full mt-6 bg-secondary text-background hover:bg-secondary/90 font-bold">
                    <Link href="https://bit.ly/polymath_brochure" target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-16 bg-card/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {/* Financial Services */}
            <Card className="w-80 bg-card border-border/50 hover:border-secondary/50 transition-all">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-medium text-sm text-foreground mb-2">What it includes:</h4>
                  <p className="text-xs text-muted-foreground">
                    Actuarial engines, underwriting pipelines, LBO/restructuring advisory tooling, compliance tech, risk models.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-sm text-foreground mb-2">Demo/Pilot Metric:</h4>
      ...
      <section className="py-16 bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="border-border/50 hover:border-secondary/50 text-foreground hover:text-secondary">
